...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SimpleAppDeploymentSpec) DeepCopyInto(out *SimpleAppDeploymentSpec) {
	*out = *in
	if in.Replicas != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SimpleAppDeploymentSpec.
func (in *SimpleAppDeploymentSpec) DeepCopy() *SimpleAppDeploymentSpec {
	if in == nil {
		return nil
	}
	out := new(SimpleAppDeploymentSpec)
	in.DeepCopyInto(out)
	return out
}
